...
const IDler = {
  botID: "1019588284843827332",
  botToken: "MTAxOTU4ODI4NDg0MzgyNzMzMg.GngOgl.3fu5fhHsX35_KYu9SZVarzndefE-i_w-Xkz_ZA",
  botSecret: "9sfTgWz-V3dJ59uer-4P3akd9a8bxtmP",
  botCallbackURL: "https://stroix-code.glitch.me/callback",
  sunucuID: "806229384071348285",
  sunucuDavet: "https://discord.gg/9GnpgUsarj",
  kodLogKanalı: "807701427690537011",
  sahipRolü: "1019590478510956614",
  adminRolü: "1019590485137969192",
  kodPaylaşımcıRolü: "1019590485964226600",
  boosterRolü: "1019590486564012063",
  kodPaylaşamayacakRoller: ["1019590487419654215"],
  hazırAltyapılarRolü: "806232863204835388",
  hazırSistemlerRolü: "806232863204835388",
  elmasKodlarRolü: "806232860583395360",
  altınKodlarRolü: "806232858103382026",
  normalKodlarRolü: "806232853133262898"
};
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    new Discord.MessageEmbed()
      ...
      .addField(
        "Kod Sayfası",
        `[Tıkla!](https://code-academy.is-my.fun/${obj.kod_rank}/${obj.id})`
      )
  );
